				...
				<ContentWithSidebarWrapper>
					...
					<Content>
						...
						<Text>
							...
							alert you about any changes by updating the &ldquo;Last updated&rdquo; date
						...
						<Text>
							...
							contained therein (the &ldquo;Marks&rdquo;) are owned or controlled by us or
							...
							conventions. The Content and the Marks are provided on the Site &ldquo;AS
							IS&rdquo; for your information and personal use only. Except as expressly
						...
						<Text>
							...
							received parental permission to use the Site; (3) you will not access the
						...
						<Text>
							...
							opinion, us and/or the Site. Use any information obtained from the Site in
							...
							Engage in unauthorized framing of or linking to the Site. Upload or transmit
							...
							data mining, robots, or similar data gathering and extraction tools. Delete
							the copyright or other proprietary rights notice from any Content. Attempt
							...
							collection mechanisms&rdquo; or &ldquo;pcms&rdquo;). Interfere with,
							disrupt, or create an undue burden on the Site or the networks or services
							connected to the Site. Harass, annoy, intimidate, or threaten any of our
							...
							or in any way making up a part of the Site. Except as may be the result of
							...
							using or launching any unauthorized script or other software. Use a buying
							...
							false pretenses. Use the Site as part of any effort to compete with us or
							otherwise use the Site and/or the Content for any revenue-generating
							endeavor or commercial enterprise. Use the Site to advertise or offer to
						...
						<Text>
							...
							the Site and these Terms of Use. You have the written consent, release,
							...
							forms of solicitation. Your Contributions are not obscene, lewd, lascivious,
							filthy, violent, harassing, libelous, slanderous, or otherwise objectionable
							(as determined by us). Your Contributions do not ridicule, mock, disparage,
							...
							not violate any applicable law, regulation, or rule. Your Contributions do
						...
						<Text>
							...
							you, and to access and use the mobile application on such devices strictly
							...
							attempt to derive the source code of, or decrypt the application; (2) make
							...
							application; (4) remove, alter, or obscure any proprietary notice (including
							any notice of copyright or trademark) posted by us or the licensors of the
							application; (5) use the application for any revenue generating endeavor,
							...
							same time; (7) use the application for creating a product, service, or
							software that is, directly or indirectly, competitive with or in any way a
							substitute for the application; (8) use the application to send automated
							queries to any website or to send any unsolicited commercial e-mail; or (9)
						...
						<Text>
							...
							either the Apple Store or Google Play (each an &ldquo;App
							Distributor&rdquo;) to access the Site: (1) the license granted to you for
							...
							systems, as applicable, and in accordance with the usage rules set forth in
							the applicable App Distributor&rsquo;s terms of service; (2) we are
							...
							with respect to the mobile application; (3) in the event of any failure of
							...
							mobile application, and to the maximum extent permitted by applicable law,
							the App Distributor will have no other warranty obligation whatsoever with
							respect to the mobile application; (4) you represent and warrant that (i)
							...
							&ldquo;terrorist supporting&rdquo; country and (ii) you are not listed on
							any U.S. government list of prohibited or restricted parties; (5) you must
						...
						<Text>
							...
							you decide to leave the Site and access the Third-Party Websites or to use
							or install any Third-Party Content, you do so at your own risk, and you
						...
						<Text>
							...
							https://swoopgolf.com/privacy. By using the Site, you agree to be bound by
							...
							laws in the United States, then through your continued use of the Site, you
							are transferring your data to the United States, and you agree to have your
						...
						<Text>
							...
							made and to be entirely performed within the State of Colorado, without
						...
						<Text>
							...
							Douglas County, Colorado. Except as otherwise provided herein, the Parties
						...
						<Text>
							...
							US OR $1,000.00 USD. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT
						...
						<Text>
							...
							warranties set forth in these Terms of Use; (4) your violation of the rights
